...
const RankInfo = ({summoner, soloRating, freeRating, summonerName}) => {
    return (
      <Item.Group divided>
        <Item>
          ...
          <Item.Content verticalAlign='middle'>
            <Item.Header as='a'>{summonerName}</Item.Header>
            <Item.Meta>
        ...
        <Item>
          ...
          <Item.Content verticalAlign='middle'>
            <Item.Header as='a'>솔로랭크</Item.Header><br/>
            <Item.Header as='a'>{soloRating.tier} {soloRating.rank}</Item.Header>
            <Item.Meta>
        ...
        <Item>
          ...
          <Item.Content verticalAlign='middle'>
            <Item.Header as='a'>자유랭크</Item.Header><br/>
            <Item.Header as='a'>{freeRating.tier} {freeRating.rank}</Item.Header>
            <Item.Meta>
