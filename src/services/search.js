...
export function getSummoner(name) {
    return axios.get(`https://cors-anywhere.herokuapp.com/https://kr.api.riotgames.com/lol/summoner/v3/summoners/by-name/${name}?api_key=RGAPI-d30e3e08-348c-45dd-a395-8da08322a7e8`);
}

// 소환사 레이팅
export function getSummoneRating(summonerId) {
    return axios.get(`https://cors-anywhere.herokuapp.com/https://kr.api.riotgames.com/lol/league/v3/positions/by-summoner/${summonerId}?api_key=RGAPI-d30e3e08-348c-45dd-a395-8da08322a7e8`);
}

// 현재 게임중
export function getCurrentStatus(summonerId) {
    return axios.get(`https://cors-anywhere.herokuapp.com/https://kr.api.riotgames.com/lol/spectator/v3/active-games/by-summoner/${summonerId}?api_key=RGAPI-d30e3e08-348c-45dd-a395-8da08322a7e8`);
}
...
export async function getGameListInfo(list) {
    ...
    list.forEach((match, i) => {
        promises.push(axios.get(`https://cors-anywhere.herokuapp.com/https://kr.api.riotgames.com/lol/match/v3/matches/${match.gameId}?api_key=RGAPI-d30e3e08-348c-45dd-a395-8da08322a7e8`));
    });
...
export function getMatchList(championId, accountId) {
    if(championId === 'recent' || championId === '전체') {
        ...
        // 챔피언에 대한 최근 20경기
        return axios.get(`https://cors-anywhere.herokuapp.com/https://kr.api.riotgames.com/lol/match/v3/matchlists/by-account/${accountId}?champion=${championId}&endIndex=20&api_key=RGAPI-d30e3e08-348c-45dd-a395-8da08322a7e8`);
    }
}
